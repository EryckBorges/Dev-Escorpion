...
// Rastreia o click para interação em redes sociais

const whatsapp = document.querySelectorAll('.whatsappClick');
const linkedin = document.querySelectorAll('.linkedinClick');
const github = document.querySelectorAll('.githubClick');
const instagram = document.querySelectorAll('.instagramClick');
const gmail = document.querySelectorAll('.gmailClick');

whatsapp.forEach((whats) => {
  whats.addEventListener('click', () => {fbq('trackCustom', 'whatsappClick');})
})

linkedin.forEach((link) => {
  link.addEventListener('click', () => {fbq('trackCustom', 'linkedinClick');})
})

gmail.forEach((gmails) => {
  gmails.addEventListener('click', () => {fbq('trackCustom', 'gmailClick');})
})

instagram.forEach((insta) => {
  insta.addEventListener('click', () => {fbq('trackCustom', 'instagramClick');})
})

github.forEach((git) => {
  git.addEventListener('click', () => {fbq('trackCustom', 'githubClick');})
})